+++
title = "gen-circleci-orb: Advanced Configuration Guide"
description = "Composing a single goal-oriented job from several commands with rich [[job_group]] — when it is worth it, how it works, and the price."
weight = 35
